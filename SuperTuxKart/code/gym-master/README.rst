...
External Games
==========================
See `Creating external game environments <docs/external-game-environment.md>`_ to create new game environments.
To download the existing set of game environments, use this link: `Drive folder with external games <https://drive.google.com/drive/folders/1CT83MgVxIpQosxEiDnjYGBrp9fw-zNWv?usp=sharing>`_. The content of the folder should be placed in a new folder named "external_games" in the root of this project.

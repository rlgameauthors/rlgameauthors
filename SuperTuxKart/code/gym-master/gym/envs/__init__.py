...
register(
    id='bastet-v0',
    entry_point='gym.envs.external_games.bastet:BastetGame',
    max_episode_steps=100000
)

register(
    id='colorgame-v0',
    entry_point='gym.envs.external_games.colorgame:ColorGame',
    max_episode_steps=100000
)

register(
    id='supertuxkart-v0',
    entry_point='gym.envs.external_games.supertuxkart:SuperTuxKart',
    max_episode_steps=100000
)
